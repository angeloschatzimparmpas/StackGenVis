...
var Context = /** @class */ (function () {
    ...
    Context.prototype.get = function (name) {
        if (!this._variables.has(name)) {
            throw new common_1.RuntimeError("'" + name + "' is undefined.");
        }
    ...
    Context.prototype.evaluateExpression = function (expression) {
        ...
        switch (expression.type) {
            case "function": {
                ...
                if (!func) {
                    throw new common_1.RuntimeError("function '" + expr.functionName + "' is undefined.");
                }
            ...
            case "field": {
                ...
                throw new common_1.RuntimeError("invalid field.");
            }
            case "constant": {
                var expr = expression;
                return expr.value;
