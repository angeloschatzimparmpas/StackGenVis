...
(function (global, factory) {
  ...
  (global = global || self, global.zoomable = factory());
  ...
  function interpolateString(a, b) {
    ...
    while ((am = reA.exec(a))
      ...
      if ((am = am[0]) === (bm = bm[0])) { // numbers in a & b match
        ...
        s[++i] = null;
        q.push({i: i, x: d3InterpolateNumber(am, bm)});
      }
      bi = reB.lastIndex;
    }
  ...
  function interpolateTransform(parse, pxComma, pxParen, degParen) {
    ...
    function translate(xa, ya, xb, yb, s, q) {
      if (xa !== xb || ya !== yb) {
        ...
        q.push({i: i - 4, x: d3InterpolateNumber(xa, xb)}, {i: i - 2, x: d3InterpolateNumber(ya, yb)});
      } else if (xb || yb) {
    ...
    function rotate(a, b, s, q) {
      if (a !== b) {
        ...
        q.push({i: s.push(pop(s) + "rotate(", null, degParen) - 2, x: d3InterpolateNumber(a, b)});
      } else if (b) {
    ...
    function skewX(a, b, s, q) {
      if (a !== b) {
        q.push({i: s.push(pop(s) + "skewX(", null, degParen) - 2, x: d3InterpolateNumber(a, b)});
      } else if (b) {
  ...
  function interpolate(a, b) {
    var c;
    return (typeof b === "number" ? d3InterpolateNumber
  ...
  var zoomable = index({
    ...
    methods: {
      ...
      zoomReset: function zoomReset(state) {
        ...
        if (state.initialised) {
          state.transitionDuration = duration;
          state.el.call(state.zoom.transform, identity$1);
        }
      ...
      zoomTo: function zoomTo(state, _ref) {
        ...
        if (state.initialised) {
          state.transitionDuration = duration;
          state.el.call(state.zoom.transform, identity$1.scale(k).translate(x, y));
        }
      ...
      state.el.call(state.zoom.on('zoom', function () {
        ...
        state.canvasCtxs.forEach(function (ctx, idx) {
          ...
          duration ? transition().duration(duration).tween("animate-ctx-".concat(idx), function () {
            var xIpol = d3InterpolateNumber(prevTr.x, tr.x);
            var yIpol = d3InterpolateNumber(prevTr.y, tr.y);
            var scXIpol = state.enableX ? d3InterpolateNumber(prevTr.k, tr.k) : function () {
              return 1;
            };
            var scYIpol = state.enableY ? d3InterpolateNumber(prevTr.k, tr.k) : function () {
              return 1;
            };
            return function (t) {
              return applyTr({
...
//# sourceMappingURL=d3-zoomable.js.map
